            ...
            <div className="flex w-full items-center justify-between">
              ...
              >
                <img
                  ...
                  loading="eager"
                  className={`${navBar || openMobile ? "h-20 lg:h-24" : "h-24 lg:h-24 mt-0"} object-contain duration-500`}
                />
              </a>
                    ...
                    >
                      {item.link ? (
                        <a
                          ...
                          className="font-medium text-lg duration-300 hover:underline decoration-yellow-400 decoration-4 underline-offset-[10px] py-12 whitespace-nowrap group-last:font-bold group-last:rounded-md group-last:bg-blue-900 group-last:py-3 group-last:px-5 group-last:hover:bg-blue-500 group-last:hover:no-underline"
                        >
