...
export const SITE_DESCRIPTION =
  "PennJet LLC offers aircraft management services, private charter, operational support, maintenance oversight, fiscal management, pilot services. Contact us today to learn more!";
...
export const KEYWORDS =
  "aircraft management services, private charter, operational support, maintenance oversight, fiscal management, pilot services, pottstown pennsylvania";

export const OG_IMAGE = "/penn-jet-og-image.png";
